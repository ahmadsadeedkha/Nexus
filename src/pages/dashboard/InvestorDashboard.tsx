...
import { getRequestsFromInvestor } from "../../api/collaborationRequests";
...
export const InvestorDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([getEntrepreneurs(), getRequestsFromInvestor(user.id)])
      .then(([entrepreneursData, requestsData]) => {
